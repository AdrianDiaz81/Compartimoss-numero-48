...
namespace Compartimoss.Example.Throttling.Utilities
{
	internal static class Extensions
	{
		public static bool IsUrlMatch(this string source, string value, bool useRegex)
		{
			if (useRegex)
			{
				return source.IsRegexMatch(value);
			}
		...
		public static string RetryAfterFrom(this DateTime timestamp, Rule rule)
		{
